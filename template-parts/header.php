...
$result = $mysqli->query("SELECT `name` FROM `institution`");
...
<nav class="uk-navbar-container uk-light" uk-navbar uk-sticky>
  <div class="uk-navbar-left">
    <a class="uk-navbar-item uk-logo uk-visible@m" href="<?php echo ABSPATH; ?>/index.php"><i class="far fa-project-diagram"></i>&nbsp;<?php echo $name; ?></a>
...
<div id="offcanvas-nav" uk-offcanvas="overlay: true">
  <div class="uk-offcanvas-bar">
    <h2><i class="far fa-project-diagram"></i>&nbsp;<?php echo $name; ?></h2>
    <ul class="uk-nav uk-nav-default">
    <li><a href="<?php echo ABSPATH; ?>/index.php">Dashboard</a></li>
    <li><a href="<?php echo ABSPATH; ?>/activity.php">Activity</a></li>
    <li class="uk-nav-divider"></li>
    <li><a href="<?php echo ABSPATH; ?>/teams/index.php">Teams</a></li>
    <li><a href="<?php echo ABSPATH; ?>/projects/index.php">Projects</a></li>
    <li><a href="<?php echo ABSPATH; ?>/tasks/index.php">Tasks</a></li>
    <li><a href="<?php echo ABSPATH; ?>/discussions/index.php">Discussions</a></li>
